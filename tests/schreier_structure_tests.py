...
from cgt.schreier_structure import DirectSchreierStructure, GraphSchreierStructure
#from cgt.schreier_sims_randomised import RandomSchreierGenerator
from cgt.schreier_sims import get_schreier_structure
...
class TestDirectSchreierStructure(unittest.TestCase):
    ...
    def test_memebership_index(self):
        ...
        self.assertEqual(len(set(S5_group)), 120)
        self.assertEqual(S5_group, sorted(S5_group, key = perm_key))
        ...
        self.assertEqual(len(set(real_group)), 60)
        self.assertEqual(real_group, sorted(real_group, key = perm_key))
        ...
        for ele in S5_group:
            ...
            if ele in struct:
                ...
                self.assertEqual(real_group[cand_index], ele)
            else:
