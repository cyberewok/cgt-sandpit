...
from schreier_sims_legacy import schreier_sims_algorithm, schreier_sims_algorithm_fixed_base, naive_schreier_sims_algorithm
from schreier_sims_legacy import membership_siftee, base_image_member
from schreier_sims_legacy import _coset_rep_inverses, _coset_reps, _coset_rep_inverse
from schreier_sims_legacy import _schreier_graph, _schreier_graph_expand
from schreier_sims_legacy import _schreier_generators
from schreier_sims_legacy import group_size, element_at_index, membership_index

class TestSchreierSimsLegacy(unittest.TestCase):
    ...
    def test_schreier_sims_algorithm(self):
        ...
        self.assertEquals(info, ([],[],[],[]))
        base, gens, c_gens, graphs = schreier_sims_algorithm([b,a], e)
        self.assertEquals(len(base), 3)
    
    def test_schreier_sims_algorithm_all_schreier_generators(self):
        #THIS TEST FAILS
        cf  =Permutation.read_cycle_form
        e = cf([], 5)
        h = cf([[1, 3, 2], [4, 5]], 5)
        i = cf([[1, 2], [3, 4]], 5)  
        base, gens, c_gens, graphs = schreier_sims_algorithm([h,i], e)
        #self.assertEquals(group_size(graphs),120)
    ...
    def test_naive_schreier_sims_algorithm(self):
        ...
        h = cf([[1, 3, 2], [4, 5]], 5)
        i = cf([[1, 2], [3, 4]], 5)  
        base, gens, c_gens, graphs = naive_schreier_sims_algorithm([h,i], e)
        self.assertEquals(group_size(graphs),120)     
...
def all_tests_suite():
    ...
    suite.addTest(unittest.makeSuite(TestSchreierSimsLegacy))
    return suite
